...
public interface Pointer {
    ...
    implements Pointer {
        ...
        protected Default(long param1) {
            if (Checks.CHECKS && param1 == 0L) {
        ...
        public boolean equals(@Nullable Object param1) {
            ...
            if (!(param1 instanceof Pointer)) {
                return false;
            }
            Pointer v2 = (Pointer)param1;
        ...
        static {
            try {
                ...
                throw new UnsupportedOperationException(v0);
            }
        }
    }
}
