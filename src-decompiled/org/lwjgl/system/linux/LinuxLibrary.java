...
extends SharedLibrary.Default {
    public LinuxLibrary(String param1) {
        this(param1, LinuxLibrary.loadLibrary(param1));
    }

    public LinuxLibrary(String param1, long param2) {
        super(param1, param2);
    }
    ...
    private static long loadLibrary(String param0) {
        ...
        Throwable v2 = null;
        try {
            v3 = DynamicLinkLoader.dlopen(v1.UTF8(param0), 1);
            if (v1 != null) {
                v1.close();
            }
        }
