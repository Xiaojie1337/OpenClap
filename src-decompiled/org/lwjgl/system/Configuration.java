...
public class Configuration<T> {
    ...
    Configuration(String param1, StateInit<? extends T> param2) {
        this.property = param1;
        this.state = param2.apply(param1);
    }
    ...
    public void set(@Nullable T param1) {
        this.state = param1;
    }
    ...
    extends Function<String, T> {
        public static final StateInit<Boolean> BOOLEAN = param0 -> {
            String v1 = System.getProperty(param0);
            return v1 == null ? null : Boolean.valueOf(Boolean.parseBoolean(v1));
        };
